...
namespace Software
{
    public partial class Engineering : Form
    {
        ...
        public Engineering()
        {
            ...
            //Measurement 1
            btn_Measure1Func.Checked = true;
            //Measurement 2
            btn_Measure2Func.Checked = true;
            //Force & Displacement
            btn_ForceDisplacement.Checked = true;
        ...
        private void MachineStatus_Tick(object sender, EventArgs e)
        {
            ...
            oFunctions.Measurement1 = btn_Measure1Func.Checked;
            //Status the Measurement 2
            oFunctions.Measurement2 = btn_Measure2Func.Checked;
            //Status the Kistler
            oFunctions.ForceDisplacement = btn_ForceDisplacement.Checked;
            //Query Limits
        ...
        public void DisableFiuncAll()
        {
            ...
            btn_UpdateDevStsFunc.Checked = false;
            //Measurement 1
            btn_Measure1Func.Checked = false;
            //Measurement 2
            btn_Measure2Func.Checked = false;
            //Force & Displacement
            btn_ForceDisplacement.Checked = false;
            //Query Limits from DB
            btn_LimitsDBFunc.Checked = false;
            //Master Parts Sequence
            btn_MasterPartsSeq.Checked = false;
