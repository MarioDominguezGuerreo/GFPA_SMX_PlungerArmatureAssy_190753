...
namespace Software
{
    class machcomm
    {
        ...
        public string[] ResultCodes = new string[]
        {
            ...
            "Test 1 Low ChX",           //Test 1: Displacement Low Limit 
            "Test 1 High ChX",          //Test 1: Displacement High Limit 
            "Test 1 Low ChY",           //Test 1: Force Low Limit 
            "Test 1 High ChY",          //Test 1: Force High Limit 
            "Test 2 Low ChX",           //Test 2: Displacement Low Limit 
            "Test 2 High ChX",          //Test 2: Displacement High Limit 
            "Test 2 Low ChY",           //Test 2: Force Low Limit 
            "Test 2 High ChY",          //Test 2: Force High Limit 
            "Const k Low",              //Constant K: Low Limit 
            "Const k high"              //Constant K: High Limit 
        };
        #endregion
